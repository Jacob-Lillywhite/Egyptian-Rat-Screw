...
function updateCardNum(deckNum, playerId)

{
  ...
  if(playerId == 1){
    ...
    document.getElementById("playerCardCountText").innerText = deckNum[1];

    document.getElementById("opponentCardCountText").innerText = deckNum[2];

  }

  else{

    document.getElementById("playerCardCountText").innerText = deckNum[2];

    document.getElementById("opponentCardCountText").innerText = deckNum[1];
...
function updateNames(name,turnOwner, playerId){

  if(playerId == 1){

    document.getElementById("playerName").innerText = name[1];

    document.getElementById("opponentName").innerText = name[2];

  }

  else{

    document.getElementById("playerName").innerText = name[2];

    document.getElementById("opponentName").innerText = name[1];

  }



  document.getElementById("turnOwnerDiv").innerHTML = "TURN: <br/>" + turnOwner;
...
function endGame(gameWinner, playerId)

{

  if(gameWinner != 0){

    if(playerId == gameWinner){
